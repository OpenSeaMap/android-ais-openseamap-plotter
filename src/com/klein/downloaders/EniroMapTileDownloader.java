 ...
 *  Version 2  12_11_15
 */
public class EniroMapTileDownloader extends TileDownloader {
	...
	private static final String TILES_DIRECTORY ="/geowebcache/service/tms1.0.0/map/";
	...
	//private static final String CACHE_DIR_NAME =  "Cachedata/EniroMap"; // we keep an own cache dir for the tiles
	private static final String CACHE_DIR_NAME =  "/EniroMap"; // we keep an own cache dir for the tiles
	private static final String CACHE_TILE_PREFIX = "EniroMapTile_";
	 ...
	 */
	public EniroMapTileDownloader(Context myContext, int aTimeout) {
		super();
		mContext = myContext;
