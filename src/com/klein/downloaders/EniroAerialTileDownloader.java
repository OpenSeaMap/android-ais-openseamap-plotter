...
public class EniroAerialTileDownloader extends TileDownloader {
	...
	//private static final String CACHE_DIR_NAME =  "Cachedata/EniroAerial"; // we keep an own cache dir for the tiles
	private static final String CACHE_DIR_NAME =  "/EniroAerial"; // we keep an own cache dir for the tiles
	private static final String CACHE_TILE_PREFIX = "EniroAerialMapTile_";
	 ...
	 */
	public EniroAerialTileDownloader(Context myContext, int aTimeout) {
		super();
		mContext = myContext;
		...
		String cacheDirName = "/" + AISPlotterGlobals.DEFAULT_ONLINE_TILE_CACHE_DATA_DIRECTORY + CACHE_DIR_NAME;        // AISPlotter/Cachedata/EniroAerial
